...
import * as CycleCreator from '../shared-types/p2p/CycleCreatorTypes'
...
import { StateHashes, ReceiptHashes, SummaryHashes, PartitionNum, PartitionRanges, offerResponse } from '../shared-types/p2p/SnapshotTypes'
