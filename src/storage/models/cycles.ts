...
const cycles = [
  'cycles',
  {
    ...
    lostArchivers: { type: Sequelize.TEXT, allowNull: false },
    refutedArchivers: { type: Sequelize.TEXT, allowNull: false },
    removedArchivers: { type: Sequelize.TEXT, allowNull: false },
