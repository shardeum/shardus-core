...
storage = new Storage(logger, '.', { confFile: './config/storage.json' });
...
test('Testing _isKnownNode and _areEquivalentNodes method', async (t) => {
    ...
    let secondNode = Object.assign(Object.assign({}, node), { internalIp: '127.0.0.2', externalIp: '127.0.0.2', internalPort: 9002, externalPort: 9002 });
...
//# sourceMappingURL=p2p-state.spec.js.map