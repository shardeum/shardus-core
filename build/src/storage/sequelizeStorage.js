...
class SequelizeStorage {
    ...
    _read(table, where, opts) {
        return table.findAll(Object.assign({ where }, opts));
    }
    _update(table, values, where, opts) {
        return table.update(values, Object.assign({ where }, opts));
    }
    _delete(table, where, opts) {
        if (!where) {
            return table.destroy(Object.assign({}, opts));
        }
        return table.destroy(Object.assign({ where }, opts));
    }
